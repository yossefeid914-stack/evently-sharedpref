...
abstract class AppLocalizations {
  ...
  /// No description provided for @please_enter_repassword.
  ///
  /// In en, this message translates to:
  /// **'Please Enter Re-Password'**
  String get please_enter_repassword;
  ...
  /// No description provided for @repassword_validation.
  ///
  /// In en, this message translates to:
  /// **'Re-Password doesn\'t match Password.'**
  String get repassword_validation;
